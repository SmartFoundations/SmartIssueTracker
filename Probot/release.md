...
If you have installed an alpha version of the mod from Finalomega, launching SMM may overwrite or remove the alpha version and replace it with a version that SMM has available.
