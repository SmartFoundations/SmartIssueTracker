...
NOTE: This feature is currently planned as a separate mod from Smart! Check back for more information!
...
The camera perspective can be changed by pressing <[>. (default keybind)
The camera zoom can be changed by holding <]> and using the scroll wheel to adjust. (default keybind)
